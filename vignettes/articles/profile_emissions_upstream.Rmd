...
The parameter `chunks` defaults to `NULL`, which splits your `*companies`
dataset in just  enough chunks to distribute companies evenly across the cores
available in your computer. Consider manually adjusting the `chunks` parameter
to find a good balance between memory-usage and speed. A small number of
...
The other settings need no action, but you may read the comments and the
