...
sector_profile_upstream_at_product_level <- unnest_product(sector_profile_upstream)
sector_profile_upstream_at_product_level

sector_profile_upstream_at_company_level <- unnest_company(sector_profile_upstream)
